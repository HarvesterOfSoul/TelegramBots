...
# user config
Control_Channel_URL = 'https://t.me/joinchat/xxxxxxxxxxxxxxx'
...
# user config
client = CreateClient(session=Session_File, api_id=123456, api_hash='0123456789abcdefg', connection_retries=1000).start()
